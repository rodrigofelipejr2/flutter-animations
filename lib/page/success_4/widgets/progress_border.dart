    ...
    if (halfWidth <= 0.0) {
      ...
      _paint(
        ...
        Path()
          ...
          ..relativeArcToPoint(Offset(borderRadius.topRight.x, borderRadius.topRight.y),
              radius: borderRadius.topRight.deflate(halfWidth / 2), rotation: 90)
          ..relativeLineTo(0, rect.height - borderRadius.topRight.y - borderRadius.bottomRight.y - side.width)
          ..relativeArcToPoint(Offset(-borderRadius.bottomRight.x, borderRadius.bottomRight.y),
              radius: borderRadius.bottomRight.deflate(halfWidth / 2), rotation: 90)
          ..relativeLineTo(side.width + borderRadius.bottomRight.x + borderRadius.bottomLeft.x - rect.width, 0)
          ..relativeArcToPoint(Offset(-borderRadius.bottomLeft.x, -borderRadius.bottomLeft.y),
              radius: borderRadius.bottomLeft.deflate(halfWidth / 2), rotation: 90)
          ..relativeLineTo(0, side.width + borderRadius.bottomLeft.y + borderRadius.topLeft.y - rect.height)
          ..relativeArcToPoint(Offset(borderRadius.topLeft.x, -borderRadius.topLeft.y),
              radius: borderRadius.topLeft.deflate(halfWidth / 2), rotation: 90)
          ..close(),
        paint,
        progress,
      );
  ...
  static void _paintUniformBorderWithCircle(
    ...
    _paint(
      ...
      Path()
        ...
        ..relativeArcToPoint(Offset(0, size - width), radius: Radius.circular(radius), rotation: 180)
        ..relativeArcToPoint(Offset(0, width - size), radius: Radius.circular(radius), rotation: 180),
      paint,
      progress,
    );
  }
